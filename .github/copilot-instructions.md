...
## Build and Test
Build via Unity Editor menu "Build/Build WebGL" using `Assets/Editor/BuildScript.cs`. Test in Unity play mode. Requires Unity 2022.3.62f3+. See README.md for setup and VR configuration.
